...
import { FaFolderPlus, FaCommentDots, FaRocket,FaGithub, FaTwitter, FaLinkedin, FaEnvelope } from "react-icons/fa";
...
<section className="pricing">
    ...
    <section className="cta-section">
      ...
      <div className="cta-box">
        ...
        {/* SUBTEXT */}
        <p>
          Join thousands of developers who are building faster and smarter with
          VocodeAI's AI-powered workspace.
        </p>
    ...
    <footer className="footer">
      ...
      <div className="footer-container">
        ...
        <div className="footer-left">
          ...
          <p>
            Build, code, and execute with AI — all in one workspace.
          </p>
      ...
      <div className="footer-bottom">
        ...
        <span>
          Made with <span className="highlight">AI</span> and 💚
        </span>
      </div>
